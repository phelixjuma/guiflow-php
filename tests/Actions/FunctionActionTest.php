...
//        $this->assertEquals($data, $expectedData);
    ...
    public function _testFilterInArray()
    {
        ...
        $filterCriteria = [
            ...
            "conditions" => [
                [
                    'term' => ["in_item_path" => "product_codes.*.code"],
                    "mode" => "not in",
                    "key" => "product_code",
                    'threshold' => "",
    ...
    public function _testFuzzyExtractTopN2()
    {
        $data = [
            "items" => [
                [
                    "description" => "KWV BRANDY COLA 440ML",
                    "pack_size" => "400ML",
                    "products"  => [
                        ["description" => "KWV 10 Yrs 12x375ml", "pack_size" => "12 X 375ML"],
                        ["description" => "KWV 10 Yrs 12x50ml", "pack_size" => "12 X 50ML"]
                    ]
                ]
            ]
        ];

        $args = ["query" => ["path" => "pack_size"], "choices" => ["path" => "products"], "searchKey" => "pack_size", "n" => "1", "minScore" => "0", "order" => "desc", "fuzzy_method" => "tokenSetRatio", "stop_words" => ""];
    ...
    public function _testGetObjectFromList()
    {
        $data = [
            ...
            "item_categories"  => [
                ["item" => "1000ML", "category" => ["name" => "Category 1"]],
                ["item" => "2000ML", "category" => ["name" => "Category 2"]],
            ]
        ];
